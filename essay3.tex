...
Women who have embarked on a degree program have already taken the important step of declaring an interest in CS (itself the subject of many diversity programs), so if we want more female CS graduates, they are a great target for our efforts.  % low-hanging fruit argument
